...
// ---- instanciate robots ----
var dancers = [];
var dancers_number = canvas.width < 600 ? 3 : 6;

for (var i = 0; i < dancers_number; i++) {
	dancers.push(new Robot(i * 360 / 7, 80, 4, (i + 2) * canvas.width / (dancers_number + 3), canvas.height * ground - 295, struct));
}
